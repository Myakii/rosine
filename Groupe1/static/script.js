  ...
  fetch("http://localhost:5000/velib")
    ...
    .then((data) => {
      ...
      data.forEach((station, index) => {
        ...
        const url = `/favoris?&id_user={id_user}&nom=${station.name}&numbikesavailable=${numbikesavailable}&numdocksavailable=${numdocksavailable}&ebike=${ebike}&mechanical=${mechanical}`;
